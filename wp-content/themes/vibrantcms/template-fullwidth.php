...
<div id="content" class="fullspan">
	...
	<div class="container_16 clearfix">
		...
		<div id="leftcontent" class="grid_16">
		...
		<?php if (have_posts()) : ?>
			...
			<div class="post">
				...
				<h2 class="title" style="margin-top: 0px !important;"><a title="<?php _e('Permanent Link to',woothemes); ?> <?php the_title(); ?>" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h2>				
